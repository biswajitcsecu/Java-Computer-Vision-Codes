public class Java2DFilter extends JFrame {
  ...
  public Java2DFilter() {
    ...
    imagePanel = new ImagePanel(Java2DFilter.class.getResource("yourImage.png"));
  ...
  public static void main(String args[]) {
    Java2DFilter application = new Java2DFilter();
